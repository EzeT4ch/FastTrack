...
namespace FastTrack.Core.Entities
{
    public class PurchaseOrder : IEntity, ICreatedAuditable, IUpdateAuditable
    {
        ...
        private PurchaseOrder(string externalOrderKey, SimpleStatus status, int totalLines, int totalQuantity, int kioskId, int userId)
        {
        ...
        public static PurchaseOrder Create(string externalOrderKey, SimpleStatus status, int totalLines, int totalQuantity, int kioskId, int userId)
        {
